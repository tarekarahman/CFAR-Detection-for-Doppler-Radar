...
for i=1:length(t)         
    ...
    Rx(i) = cos(2*pi*(fc*(t(i)-delta_t)+0.5*Slope*(t(i)-delta_t)^2));
...
subplot(2,1,1)
 ...
 % *%TODO* :
 % plot FFT output 
 range_axis2 = linspace(0,200,Nr/2)*((Nr/2)/200);
 plot(range_axis2,P1(:,1)');
 ylabel('|P(R)|');
 xlabel('R');
...
%Doppler Response output.
 ...
 figure,surf(doppler_axis,range_axis,thresholded_output);
 colorbar;
